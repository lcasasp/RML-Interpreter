...
and defn =
  | DLet of var info * expr info
  | DLetRec of var info * expr info
...
and expr =
  ...
  | Nil
  | Cons of expr info * expr info
  | Fun of var info * expr info
  | App of expr info * expr info
  | PipeApp of expr info * expr info
